...
- 允许的父元素：`button-group`、`navbar-el`、`panel-el`、任意 `rp-*` 容器
- 允许的子元素：无（自闭合）

## 示例

```html
<button-el label="新建任务" variant="primary" icon="plus"></button-el>
<button-el label="删除" variant="danger" state="loading"></button-el>
```
